...
export default function SignupPage() {
  ...
  const { setAnonymousId } = useAppStore();
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start your productive study journey today</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button variant="ghost" className="w-full text-muted-foreground" onClick={handleDemoLogin}>Try demo mode</Button>
